...
type dbGetAccountByIdScenario struct {
	scenarioName        string
...
func TestDbGetAccountById(t *testing.T) {
	...
	scenarios := getDbGetAccountByIdScenarios()
...
func getDbGetAccountByIdScenarios() []dbGetAccountByIdScenario {
	return []dbGetAccountByIdScenario{
		{
