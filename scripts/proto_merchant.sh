...
protoc -I. -I"$GOPATH"/src -I="$GOPATH"/src/github.com/infobloxopen/protoc-gen-gorm \
       ...
       --gogoopsee_out=plugins=grpc+graphql,Mopsee/protobuf/opseeproto=github.com/opsee/protobuf/opseeproto,Mgoogle/protobuf/descriptor.proto=github.com/gogo/protobuf/protoc-gen-gogo/descriptor:./internal/merchant/ \
			 --proto_path="$GOPATH"/src:./internal/merchant/merchant.proto
