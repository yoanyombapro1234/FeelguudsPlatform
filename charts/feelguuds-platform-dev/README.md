...
Feelguuds is a social ecommerce platform aimed at helping consumers engage in cause conscious commerce.
It follows best practices necessary to run distributed systems in kubernetes

Feelguufs was built based off the template `podinfo` project whic is used by CNCF projects like [Flux](https://github.com/fluxcd/flux2)
...
```console
$ helm repo add podinfo https://yoanyomba1234.github.io/feelguuds-platform

$ helm upgrade -i my-release FeelguudsPlatform/feelguuds-platform
```

The command deploys feelguuds platform on the Kubernetes cluster in the default namespace.
...
```console
$ helm install my-release FeelguudsPlatform/feelguuds-platform \
...
```console
$ helm install my-release FeelguudsPlatform/feelguuds-platform -f values.yaml
```
